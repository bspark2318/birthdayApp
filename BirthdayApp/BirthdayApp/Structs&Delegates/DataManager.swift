...
//  Sourced from https://www.freecodecamp.org/news/how-to-make-your-first-api-call-in-swift/
...
public class DataManager: ObservableObject {
    ...
    // Convert from data to birthday object
    ...
    // Sort birthdays based on number of days
    func sortBirthdays() {
    ...
    // API call to get user's birthdays
    ...
    // API call to create new birthday
